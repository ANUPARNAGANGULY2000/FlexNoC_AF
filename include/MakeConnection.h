...
class MakeConnection{
  public:
	MakeConnection()=default;
        ~MakeConnection()=default;
static void create_connection(const std::string &node_name,const std::string &source, const std::string &destination, dot_lang::Mapping &mapping, double pipeline_delay);
